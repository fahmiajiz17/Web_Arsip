...
<body>
        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    {{-- Page Title --}}
                    <div class="card card-body" style="background-color: #14438B">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <div class="copyright ms-auto">
                        &copy; 2025 - <a href="" target="_blank" class="text-brand fw-semibold">Sistem Informasi</a>. Institut Teknologi Nasional Bandung
                    </div>
                </div>
            </footer>
        </div>
    ...
    <script src="{{ asset('js/template/try.js') }}"></script>
