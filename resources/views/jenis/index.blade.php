            ...
            <div class="d-sm-flex flex-sm-row-reverse justify-content-between align-items-center mb-4">
                <div class="d-grid gap-2 mb-3 mb-sm-0">
                    ...
                    <a href="{{ route('jenis.create') }}" class="btn btn-primary">
                        <i class="ti ti-plus me-2"></i> Tambah Jenis
                    </a>
                </div>

                {{-- form pencarian --}}
                <form action="{{ route('jenis.index') }}" method="GET" class="position-relative">
                    ...
                    @forelse ($jenis as $data)
                        ...
                        <tr>
                            ...
                            <td width="200">
                                ...
                                <a href="{{ route('jenis.edit', $data->id) }}" class="btn btn-primary btn-sm m-1" data-bs-tooltip="tooltip" data-bs-title="Ubah">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title" id="exampleModalLabel">
                                            <i class="ti ti-trash me-1"></i> Hapus Data Jenis Dokumen
                                        </h1>
                                    </div>
                                    <div class="modal-body">
                                        {{-- informasi data yang akan dihapus --}}
                                        <p class="mb-2">
                                            Anda yakin ingin menghapus data jenis dokumen <span class="fw-bold mb-2">{{ $data->nama }}</span>?
                                        </p>
                                    </div>
