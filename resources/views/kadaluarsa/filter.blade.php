<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            ...
            {{-- form filter data --}}
            <form action="{{ route('kadaluarsa.filter') }}" method="GET">
                <div class="row">
                ...
                {{-- action buttons --}}
                <x-form-action-buttons>kadaluarsa</x-form-action-buttons>
            </form>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-grid gap-2 mb-3 mb-sm-0">
                        ...
                        <a href="{{ route('kadaluarsa.print', [request('jenis'), request('tgl_awal'), request('tgl_akhir')]) }}" target="_blank" class="btn btn-warning px-4">
