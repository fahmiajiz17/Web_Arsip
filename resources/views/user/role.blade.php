<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
                    ...
                    @forelse ($role as $data)
                        ...
                        <tr>
                            ...
                            <td width="200">
                                ...
                                <a href="{{ route('role.edit-role', $data->id) }}" class="btn btn-primary btn-sm m-1" data-bs-tooltip="tooltip" data-bs-title="Ubah">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title" id="exampleModalLabel">
                                            <i class="ti ti-trash me-1"></i> Hapus Data Role
                                        </h1>
                                    </div>
                                    <div class="modal-body">
                                        {{-- informasi data yang akan dihapus --}}
                                        <p class="mb-2">
                                            Anda yakin ingin menghapus role <span class="fw-bold mb-2">{{ $data->nama }}</span>?
                                        </p>
                                    </div>
            ...
            {{-- pagination --}}
            <div class="pagination-links">{{ $role->links() }}</div>
        </div>
    </div>
</x-app-layout>
