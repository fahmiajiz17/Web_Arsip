        ...
        <div class="d-flex justify-content-around w-50">
            ...
            <div class="border rounded text-center p-3 mx-2">
                @if ($profil->logo_instansi)
                    <img src="{{ asset('storage/logo/' . $profil->logo_instansi) }}" class="img-fluid p-2" width="150" alt="Logo Instansi">
                @else
                    <img src="{{ asset('/images/default-logo.png') }}" class="img-fluid p-2" width="150" alt="Logo Instansi">
                @endif
                <p>Logo Instansi</p>
            </div>
            ...
            <div class="border rounded text-center p-3 mx-2">
                @if ($profil->logo_kerjasama)
                    <img src="{{ asset('storage/logo/' . $profil->logo_kerjasama) }}" class="img-fluid p-2" width="150" alt="Logo Kerjasama">
                @else
                    <img src="{{ asset('/images/default-logo.png') }}" class="img-fluid p-2" width="150" alt="Logo Kerjasama">
                @endif
                <p>Logo Kerjasama</p>
            </div>
        </div>
